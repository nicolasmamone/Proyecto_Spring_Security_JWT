...
public class FacturaUtils {
    ...
    public static boolean isFileExist(String path){ // Le paso la ruta del archivo pdf que quiero obtener, si ese archivo es diferente a null y existe entonces true.
